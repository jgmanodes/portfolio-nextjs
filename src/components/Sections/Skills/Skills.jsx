...
function Skills() {
  return (
    <div id="skills" className={commonStyles.section}>
      <h2 className={redHat500.className}>Habilidades</h2>
      <div className={styles.container}>
        <p className={roboto300.className}>Estas son algunas tecnologías que conozco y he utilizado para desarrollar mis proyectos.</p>
